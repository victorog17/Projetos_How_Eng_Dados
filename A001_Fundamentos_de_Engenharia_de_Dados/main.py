...
A combinação de Pares, Ímpares e Primos mais frequente é: {} com a frequencia de: {:.2f}%
'''.format(freq_nr[-1][0], freq_nr[0][0], resultado['Combinacao'].values[-1], resultado['p_freq'].values[-1]*100)
)
